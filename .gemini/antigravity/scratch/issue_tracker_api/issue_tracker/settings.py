...
SECRET_KEY = "django-insecure-169jc6fq3t^9)-@sbq8)nv@7^5*@wr#w=re!=6t&_ho+@3^5-4"
...
# Use PostgreSQL if USE_POSTGRES environment variable is set, otherwise use SQLite
if os.environ.get('USE_POSTGRES', 'false').lower() == 'true':
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.postgresql",
            "NAME": os.environ.get("DB_NAME", "issue_tracker_db"),
